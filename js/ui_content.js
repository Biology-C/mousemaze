...
window.UI_I18N = Object.freeze({
  zh: Object.freeze({
    ...
    edu_levels_intro: "選一條數字迷宮，慢慢找出規律。",
    edu_next: "下一個：",
    edu_find_missing: "想一想：下一個數字是？",
    edu_all_done: "全部完成！",
    edu_try_again: "再想一想。",
    edu_reference: "看看這一排：",
    edu_nudge_plus_one: "再想想：每次往前數 1。",
    edu_nudge_plus_two: "再想想：每次都多 2。",
    edu_nudge_even: "看看上面那排：這一排也每次多 2。",
    edu_nudge_plus_five: "再想想：每次加一組 5。",
    edu_complete_title: "太棒了！",
    edu_complete_copy: "你找到了完整的數字規律！",
    edu_next_level: "下一關",
    edu_replay: "再玩一次",
    edu_choose_level: "選擇關卡",
    edu_home: "回主選單",
    edu_l1_name: "一步一步數",
    edu_l1_title: "🧩 小小探險家 · 第 1 關",
    edu_l1_rule: "先照順序走：每次多 1",
    edu_l1_complete: "你找到了 1 到 5 的順序！",
    edu_l2_name: "每次多 2",
    edu_l2_title: "🧩 小小探險家 · 第 2 關",
    edu_l2_rule: "跳一格數：每次多 2",
    edu_l2_complete: "你走完了每次多 2 的路線！",
    edu_l3_name: "找最後一格",
    edu_l3_title: "🧩 小小探險家 · 第 3 關",
    edu_l3_rule: "最後一個數字躲起來了",
    edu_l3_complete: "你找到了最後少掉的數字！",
    edu_l4_name: "找中間一格",
    edu_l4_title: "🧩 小小探險家 · 第 4 關",
    edu_l4_rule: "中間少了一個，找出它",
    edu_l4_complete: "中間的空格也難不倒你！",
    edu_l5_name: "找兩個空格",
    edu_l5_title: "🧩 小小探險家 · 第 5 關",
    edu_l5_rule: "兩個空格，慢慢找",
    edu_l5_complete: "你完成了兩個空格的挑戰！",
    edu_l6_name: "奇數與偶數",
    edu_l6_title: "🧩 小小探險家 · 第 6 關",
    edu_l6_rule: "看範例：兩排都每次多 2",
    edu_l6_complete: "你發現奇數和偶數都能每次多 2！",
    edu_l7_name: "每次多 5",
    edu_l7_title: "🧩 小小探險家 · 第 7 關",
    edu_l7_rule: "每袋 5 塊起司：每次多 5",
    edu_l7_complete: "你數完了 5 組一袋的起司！",
    edu_l8_name: "多 5 挑戰",
    edu_l8_title: "🧩 小小探險家 · 第 8 關",
    edu_l8_rule: "空格裡少了哪些 5 的倍數？",
    edu_l8_complete: "八關完成！你已經會找每次多 5 的規律了！",
    enter_name: "輸入冒險者名稱",
    confirm_start: "確認出發",
    back: "返回"
  }),
  en: Object.freeze({
    ...
    edu_levels_intro: "Choose a number maze and discover its pattern at your own pace.",
    edu_next: "Next: ",
    edu_find_missing: "Think: what number comes next?",
    edu_all_done: "All done!",
    edu_try_again: "Think once more.",
    edu_reference: "Look at this row:",
    edu_nudge_plus_one: "Try again: count forward by 1.",
    edu_nudge_plus_two: "Try again: add 2 each time.",
    edu_nudge_even: "Look at the row above: this row also adds 2.",
    edu_nudge_plus_five: "Try again: add one group of 5.",
    edu_complete_title: "Wonderful!",
    edu_complete_copy: "You found the complete number pattern!",
    edu_next_level: "Next Level",
    edu_replay: "Play Again",
    edu_choose_level: "Choose a Level",
    edu_home: "Main Menu",
    edu_l1_name: "Count Step by Step",
    edu_l1_title: "🧩 Little Explorer · Level 1",
    edu_l1_rule: "Follow the path: add 1 each time",
    edu_l1_complete: "You found the order from 1 to 5!",
    edu_l2_name: "Add 2 Each Time",
    edu_l2_title: "🧩 Little Explorer · Level 2",
    edu_l2_rule: "Skip-count: add 2 each time",
    edu_l2_complete: "You followed the add-2 path!",
    edu_l3_name: "Find the Last One",
    edu_l3_title: "🧩 Little Explorer · Level 3",
    edu_l3_rule: "The last number is hiding",
    edu_l3_complete: "You found the missing last number!",
    edu_l4_name: "Find the Middle",
    edu_l4_title: "🧩 Little Explorer · Level 4",
    edu_l4_rule: "One middle number is missing",
    edu_l4_complete: "You solved the missing middle number!",
    edu_l5_name: "Find Two Blanks",
    edu_l5_title: "🧩 Little Explorer · Level 5",
    edu_l5_rule: "Two blanks—take your time",
    edu_l5_complete: "You solved the two-blank challenge!",
    edu_l6_name: "Odds and Evens",
    edu_l6_title: "🧩 Little Explorer · Level 6",
    edu_l6_rule: "Use the example: both rows add 2",
    edu_l6_complete: "You found that odds and evens can both add 2!",
    edu_l7_name: "Add 5 Each Time",
    edu_l7_title: "🧩 Little Explorer · Level 7",
    edu_l7_rule: "Five cheeses per bag: add 5 each time",
    edu_l7_complete: "You counted every group of five cheeses!",
    edu_l8_name: "Add-5 Challenge",
    edu_l8_title: "🧩 Little Explorer · Level 8",
    edu_l8_rule: "Which multiples of 5 fill the blanks?",
    edu_l8_complete: "All eight levels complete—you found the add-5 pattern!",
